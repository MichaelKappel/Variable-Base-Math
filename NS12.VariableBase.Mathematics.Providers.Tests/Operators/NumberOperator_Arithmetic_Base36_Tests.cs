...
[TestCategory("Matrix")]
[TestCategory("Base36")]
public class NumberOperator_Arithmetic_Base36_Tests
{
    [DataTestMethod]
    [DynamicData(nameof(GetCases), DynamicDataSourceType.Method, DynamicDataDisplayName = nameof(GetCaseDisplayName))]
    public void ArithmeticOperators_ReturnExpectedResults_ForBase36Inputs(string baseName, string key, int caseIndex, string firstRaw, string secondRaw)
    {
    ...
    {
        return NumberOperator_Arithmetic_TestHelper.GetArithmeticCases("base36", "0123456789abcdefghijklmnopqrstuvwxyz");
    }
