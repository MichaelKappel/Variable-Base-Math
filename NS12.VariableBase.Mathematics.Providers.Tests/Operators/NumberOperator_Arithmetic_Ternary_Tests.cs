...
[TestCategory("Matrix")]
[TestCategory("Ternary")]
public class NumberOperator_Arithmetic_Ternary_Tests
{
    [DataTestMethod]
    [DynamicData(nameof(GetCases), DynamicDataSourceType.Method, DynamicDataDisplayName = nameof(GetCaseDisplayName))]
    public void ArithmeticOperators_ReturnExpectedResults_ForTernaryInputs(string baseName, string key, int caseIndex, string firstRaw, string secondRaw)
    {
    ...
    {
        return NumberOperator_Arithmetic_TestHelper.GetArithmeticCases("ternary", "012");
    }
